...
/**
 * SaaSy ML implementation of the Pipeline layer.
 *
...
public class PipelineLayer {
    ...
    private static Logger logger = LoggerFactory.getLogger(PipelineLayer.class);
     ...
     */
    public PipelineLayer(boolean thread) {
    }
